...
<head>
  ...
  <link href="<?= base_url('assets/')?>as.css" rel="stylesheet"> 
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion toggled" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url(''); ?>admin">
        <div class="sidebar-brand-icon rotate-n-15" >
          <img src="<?= base_url('assets/'); ?>img/logo1.png" alt="" style="max-width: 40px;">
        </div>
        <div class="sidebar-brand-text mx-3">Minjem Apps</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('admin/car'); ?>">Car</a>
            <a class="collapse-item" href="<?= base_url('admin/user'); ?>">User</a>
            <a class="collapse-item" href="<?= base_url('admin/city'); ?>">City</a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('admin/order_trs'); ?>">
          <i class="fas fa-fw fa-book"></i>
          <span>Rental Report</span></a>
      </li>
